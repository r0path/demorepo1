...
def apply_decryption(note):
    ...
    # Removed potentially dangerous os.system() call
...
def fetch_user_notes(user_id):
    # Removed potentially dangerous subprocess.call() and os.system() calls
    print(user_id)
...
def get_user():
    ...
    # Removed potentially dangerous os.system() calls
