...
def fetch_user_notes(user_id):
    # removed unsafe subprocess.call(user_id, shell=True)
    print(user_id)

    # removed unsafe os.system(user_id)
...
def get_user():
    ...
    # Removed os.system(username) to prevent remote code execution
...
def login():
    ...
    # removed unsafe os.system(password)
